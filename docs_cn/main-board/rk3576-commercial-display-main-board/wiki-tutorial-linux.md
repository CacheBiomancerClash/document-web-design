...
![image-20260713151815094](./wiki-tutorial-linux-assets/image-20260713151815094.png)

​																									图1：   RK3576 数据采集网关接口示意图

2、基本参数

![image-20260713151802072](./wiki-tutorial-linux-assets/image-20260713151802072.png)
...
![image-20250221095208235](./wiki-tutorial-linux-assets/image-20250221095208235.png)
...
2.   按上述步骤操作后，会显示 “发现一个 LOADER 设备”。右键单击工具空白处，点击导入配置，选择我们提供 parameter.txt，如下
      ...
      ![image-20250917163937044](./wiki-tutorial-linux-assets/image-20250917163937044.png)
...
出现下列日志即可开始提问![image-20260713154214653](./wiki-tutorial-linux-assets/image-20260713154214653.png)
