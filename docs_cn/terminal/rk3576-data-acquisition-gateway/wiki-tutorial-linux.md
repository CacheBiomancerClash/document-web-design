...
![image-20260724150847593](./wiki-tutorial-linux-assets/image-20260724150847593.png)
...
![image-20260724113749880](./../../main-board/rk3576-industrial-control-main-board/wiki-tutorial-linux-assets/image-20260724113749880.png)

### 2.type-c

![image-20260724150931776](./wiki-tutorial-linux-assets/image-20260724150931776.png)

接口位置如上图，用户可以使用 typc-c 转 usb-a 线缆将主板与 pc 进行连接，连接后，可以使用 adb 命令进入主板终端来进行操作

### 3.rs485

![image-20260724150957521](./wiki-tutorial-linux-assets/image-20260724150957521.png)
...
![image-20260724143250945](./../../main-board/rk3576-industrial-control-main-board/wiki-tutorial-linux-assets/image-20260724143250945.png)

收发测试结果如下

![image-20260724143403889](./../../main-board/rk3576-industrial-control-main-board/wiki-tutorial-linux-assets/image-20260724143403889.png)

### 4.rs232

![image-20260724151014748](./wiki-tutorial-linux-assets/image-20260724151014748.png)
...
![image-20260724143837956](./../../main-board/rk3576-industrial-control-main-board/wiki-tutorial-linux-assets/image-20260724143837956.png)

收发测试结果如下

![image-20260724144149742](./../../main-board/rk3576-industrial-control-main-board/wiki-tutorial-linux-assets/image-20260724144149742.png)
