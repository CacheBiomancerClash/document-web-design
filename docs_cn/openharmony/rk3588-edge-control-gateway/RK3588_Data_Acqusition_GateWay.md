...
title: RK3588 边缘控制网关 OpenHarmony 用户手册
---
...
1. 使用 Type-C 线连接开发板 `	TYPE-C` 口和电脑主机；
   ...
   ![image-20260709151821889](images/image-20260709151821889.png)

2. 按住开发板上的 `recovery` 键不要松开；

   ![image-20260709151851431](images/image-20260709151851431.png)

3. 接上电源适配器，开发板上电；

   ![image-20260709151739603](images/image-20260709151739603.png)
...
- 上电后，给数据网关插上hdmi线外接屏幕
  ...
  ![image-20260709171602015](images/image-20260709171602015.png)
...
![image-20260709171940526](images/image-20260709171940526.png)
...
1. 确认蓝牙天线已正确连接；
   ...
   ![image-20260709172028391](images/image-20260709172028391.png)
...
2. 插入耳机；
   ...
   ![image-20260709172059099](images/image-20260709172059099.png)
