...
1. 找到开发板上丝印标识为 `PHONE` 的接口；
   ...
   ![耳机接线图](images/Z3.5.jpg)

2. 插入耳机；

3. 打开桌面音乐播放器；

   ![音乐播放器](images/3.8.png)
