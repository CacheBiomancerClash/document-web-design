...
![232 接口](images/18.png)

串口引脚示意图（丝印标识与 TX、RX、GND 对应位置）：

![串口引脚示意图](images/w2.jpg)

**设置串口助手：**

![串口助手设置](images/19.png)
